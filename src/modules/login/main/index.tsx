...
export const Main: FC = (): ReactElement => {
  ...
  return (
    <main className="flex h-screen w-screen items-center justify-center bg-P1">
      <form
        onSubmit={handleSubmit(onSubmit)}
        className="flex h-full max-h-[600px] w-full max-w-[500px] flex-col items-center justify-center gap-5 rounded-xl bg-N1 drop-shadow-md"
      >
